  ...
  return (
    <Popover open={menuOpen} onOpenChange={setMenuOpen}>
      ...
      <PopoverContent
        align="end"
        sideOffset={8}
        className="w-[190px] rounded-lg border-border/60 bg-popover/95 p-1.5 text-popover-foreground shadow-[0_14px_36px_rgba(15,23,42,0.16)]"
        role="menu"
        data-testid="create-session-menu"
      >
