...
export function CreateSessionButton({
  ...
  return (
    <div
      className={cn(
        "inline-flex h-7 shrink-0 items-center rounded-md bg-secondary text-secondary-foreground shadow-sm",
        className,
      )}
    ...
    >
      ...
      <Popover open={menuOpen} onOpenChange={setMenuOpen}>
        ...
        <PopoverContent
          align="end"
          sideOffset={8}
          className="w-[190px] rounded-lg border-border/60 bg-popover/95 p-1.5 shadow-[0_14px_36px_rgba(15,23,42,0.16)]"
        >
